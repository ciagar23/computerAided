...
?>
  <tr class="<?php echo $class; ?>"> 
   <td><a href="<?php echo WEB_ROOT;?>admin/student/index.php?classname=<?php echo $c_id; ?>"><?php echo $c_name; ?></a></td>
   <td><a href="<?php echo WEB_ROOT;?>admin/student/index.php?classname=<?php echo $c_id; ?>"><?php echo $c_subject; ?></a></td>
   <td><a href="<?php echo WEB_ROOT;?>admin/student/index.php?classname=<?php echo $c_id; ?>"><?php echo $c_schedule; ?></a></td>
   <td><a href="<?php echo WEB_ROOT;?>admin/class/index.php?view=modify&classname=<?php echo $c_id; ?>">Modify</a></td>
