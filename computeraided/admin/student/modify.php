...
$sql = "SELECT user_fname, user_lname, user_idnumber, user_department
        FROM tbl_user
...
<form action="processUser.php?action=modify" method="post" enctype="multipart/form-data" name="frmAddUser" id="frmAddUser">
 <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" class="entryTable">
    <tr> 
   <td width="150" class="label" height="50">ID Number</td>
   <td class="content"> <?php echo $user_idnumber; ?></td>
  </tr>
