...
{
$successMessage = '<div class="msg done">
...
<div id="main">
	...
	<div id="menu" class="box">
		...
		<ul class="box">
			...
			<li><a href="<?php echo WEB_ROOT;?>admin/lessons/"><span>Lessons</span></a></li>
			<li><a href="<?php echo WEB_ROOT;?>admin/practice/"><span>Pactice</span></a></li>
			...
			<li><a href="<?php echo WEB_ROOT;?>admin/quizresult"><span>Quiz Results</span></a></li>
			<li><a href="<?php echo WEB_ROOT;?>admin/examresult"><span>Exam Results</span></a></li>
			<li><a href="<?php echo WEB_ROOT;?>admin/finalgrade"><span>Final Grade</span></a></li>
...
<p id="btn-create" class="box"><a href="<?php echo WEB_ROOT;?>admin/profile/index.php?view=background&userId=<?php echo $userId;?>"><span>Background Color</span></a></p>
<p id="btn-create" class="box"><a href="<?php echo WEB_ROOT;?>admin/profile/index.php?view=header&userId=<?php echo $userId;?>"><span>Header/Footer</span></a></p>
...
<!-- Form -->
	...
	<div id="footer" class="box">
		...
		<p class="f-left"><?php echo $footer;?></p>
