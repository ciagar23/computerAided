...
// get product info
$sql = "SELECT c_id, c_name, c_schedule, c_subject, c_ins
        FROM tbl_quiz where c_teacher ='$session' and c_id='$class'
		ORDER BY c_name";
...
<tr> 
   ...
   <td class="content"> <textarea name="txtIns" rows="5" cols="50" class="box" id="txtIns"><?php echo $c_ins;?> </textarea> 
   </td>
  </tr> 
