...
function addClass()
{
	...
	$sql   = "INSERT INTO tbl_quiz (c_name ,c_ins ,c_classid, c_subject, c_schedule, c_teacher ,c_date,c_time,c_minute)
	          VALUES ('$name','$ins','$classId', '$subject', '$schedule', '$teacher', NOW(), $time, $minute)";
...
function modify()
{
	...
	$sql   = "UPDATE tbl_quiz 
	          SET c_name = '$name', c_ins = '$ins', c_subject = '$subject', c_schedule = '$schedule', c_time = '$time', c_minute = '$minute', c_status = '$status'
