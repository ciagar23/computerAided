...
function addClass()
{
	...
	$sql   = "INSERT INTO tbl_quiz (c_name ,c_classid, c_subject, c_schedule, c_teacher ,c_date,c_time,c_minute)
...
function modify()
{
	...
	$sql   = "UPDATE tbl_quiz 
	          SET c_name = '$name', c_subject = '$subject', c_schedule = '$schedule', c_time = '$time', c_minute = '$minute'
