...
?>
				...
				{
					title: 'Purpose: <?php echo $b_purpose;?>, Teacher: <?php echo $firstname;?> <?php echo $lastname;?>',
start: new Date(<?php echo $b_by;?>, <?php echo $b_bm;?>, <?php echo $b_bd;?>, <?php echo $b_bh;?> , <?php echo $b_bmi;?>),
					...
					url: '<?php echo WEB_ROOT; ?>admin/returning/index.php?view=return&productId=<?php echo $b_id;?>',
					allDay: false
				},
