...
?>
  <tr class="<?php echo $class; ?>"> 
   <td><a href="<?php echo WEB_ROOT;?>admin/games/index.php?view=detail&classname=<?php echo $c_id; ?>"><?php echo $c_name; ?></a>
   <?php echo $status2;?></td>
    
   <td width="70" align="center"><a href="javascript:ChangeStatus(<?php echo $c_id; ?>,<?php echo $c_status; ?>);" class="ico del"><?php echo $status;?></a></td>
  </tr>
  <?php
	} // end while
?>
