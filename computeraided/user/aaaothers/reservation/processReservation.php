...
function Reserve()
{
	...
	$sql   = "INSERT INTO tbl_borrowed (b_eid, b_borrower, b_roomno, b_department, b_class, b_subject, b_by, b_bm, b_bd, b_ry, b_rm, b_rd, b_name, b_code, b_bh, b_bmi, b_rh, b_rmi, b_purpose, b_datereg)
	          
			  VALUES ('$productId', '$Borrower', '$RoomNo', '$dept','$Class',  '$Subject', '$By', '$Bm', '$Bd', '$Ry', '$Rm', '$Rd', '$Name', '$Code', '$Bh', '$Bmi', '$Rh', '$Rmi','$Purpose', NOW())";
