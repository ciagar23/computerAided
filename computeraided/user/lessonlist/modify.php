...
$sql = "SELECT c_id, c_name, c_content
        FROM tbl_lesson where c_teacher ='$session' and c_id='$class'
		ORDER BY c_name";
...
<form action="processClass.php?action=modify&productId=<?php echo $class; ?>" method="post" enctype="multipart/form-data" name="frmAddClass" id="frmAddClass">
 <p align="center" class="formTitle">Modify Lesson</p>
 ...
 <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" class="entryTable">
  ...
  <tr> 
   ...
   <td class="content"> <input name="txtName" type="text" class="box" value="<?php echo $c_name;?>" id="txtName" size="30" maxlength="100"> 
   </td>
  </tr>  
  
  <tr> 
   <td width="150" class="label" colspan="2">Lessons<br>
   <textarea name="txtContent" id="Content"><?php echo $c_content;?> </textarea>
 ...
 <p align="center"> 
  <input name="btnAddProduct" type="button" id="btnAddProduct" value="Modify" onClick="checkAddLessonForm();" class="box">
